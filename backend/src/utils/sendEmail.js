...
const sendEmail = async ({ email, subject, otp }) => {
  ...
  const mailOptions = {
    ...
    text: `Your Taskora verification code is ${otp}. It will expire in 10 minutes. Please do not share this code with anyone.`,
    html: `
      <div style="font-family: Arial, sans-serif; padding: 20px; background-color: #f4f4f4;">
        <div style="max-width: 500px; margin: 0 auto; background: #ffffff; padding: 30px; border-radius: 10px;">
          ...
          <p style="color: #888; font-size: 12px;">This code will expire in 10 minutes. If you didn't request this, please ignore this email.</p>
        </div>
      </div>
    `,
  };
